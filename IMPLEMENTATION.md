...
4. SDK loop, caching, compaction, and completion gate — implemented. Live E2E repaired a real coding fixture, preserved its tests, reran checks, and passed independent final verification. CLI amendments and explicit uncertain-action resolution are implemented; extended recovery tests follow in milestone 5.
